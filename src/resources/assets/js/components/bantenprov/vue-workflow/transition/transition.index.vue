<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Transition
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <vuetable ref="vuetable"
          api-url="/vue-workflow/transition"
          :fields="fields"
...
export default {
  ...
  methods: {                
    createRow() {      
      window.location = '#/admin/workflow/transition/create';
    },
    // viewRow(rowData) {
    ...
    deleteRow(rowData) {
      ...
      if (confirm('Do you really want to delete it?')) {
        axios.delete('/vue-workflow/transition/'+ rowData.id +'/destroy')
