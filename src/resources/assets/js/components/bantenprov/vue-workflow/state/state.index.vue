<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> State
...
export default {
  ...
  methods: {                
    createRow() {      
      window.location = '#/admin/workflow/state/create';
    },
    // viewRow(rowData) {
    //   window.location = '#/admin/group-egovernment/' + rowData.id;
    // },
    editRow(rowData) {
      window.location = '#/admin/workflow/state/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      
      let app = this;
      if (confirm('Do you really want to delete it?')) {
        axios.delete('/vue-workflow/state/'+ rowData.id +'/destroy')
