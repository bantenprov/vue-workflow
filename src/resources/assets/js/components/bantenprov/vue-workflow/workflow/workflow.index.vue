...
export default {  
  ...
  methods: {  
    ...
    createRow() {      
      window.location = '#/admin/workflow/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/workflow/' + rowData.id + '/show';
    },
    editRow(rowData) {
      window.location = '#/admin/workflow/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      
      let app = this;
      if (confirm('Do you really want to delete it?')) {
        axios.delete('/vue-workflow/workflow/'+ rowData.id +'/destroy')
          .then(function(response) {
            if (response.data.status == true) {
				app.toast_message('success','Delete','Success Delete data');
